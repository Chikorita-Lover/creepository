package com.sidden.creepository.client.menu;

import com.sidden.creepository.block.entity.KegBlockEntity;
import com.sidden.creepository.client.slot.KegResultSlot;
import com.sidden.creepository.registry.CreepositoryBlocks;
import com.sidden.creepository.registry.CreepositoryMenus;
...
public class KegMenu extends AbstractContainerMenu {
    ...
    public KegMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(CreepositoryMenus.KEG.get(), pContainerId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, CreepositoryBlocks.KEG.get());
    }
