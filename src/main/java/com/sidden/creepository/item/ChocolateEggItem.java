...
public class ChocolateEggItem extends Item implements ProjectileItem {
    public ChocolateEggItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ThrownChocolateEgg thrownegg = new ThrownChocolateEgg(level, player);
    ...
    public Projectile asProjectile(Level level, Position pos, ItemStack stack, Direction direction) {
        ThrownChocolateEgg thrownegg = new ThrownChocolateEgg(level, pos.x(), pos.y(), pos.z());
